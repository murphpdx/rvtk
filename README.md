...
We also use a number of Node.js tools to initialize and test the project. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `rv3k`

Clone the `rv3k` repository using git:
...
`rvtk` changes this location through the `.bowerrc` file. Putting it in the `app` folder
...
The `rvtk` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
